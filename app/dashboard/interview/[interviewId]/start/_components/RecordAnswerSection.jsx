...
function RecordAnswerSection({mockInterviewQuestion,activeQuestionIndex,interviewData}) {
    ...
    const UpdateUserAnswer=async()=>{
        ...
        "please give us rating for the answer and feedback as area of improvement if required"+
    ...
    return (
        <div className='flex items-center justify-center flex-col'>
            ...
            <Button 
            disabled={loading}
            varient="outline" className="my-10"
            ...
            >
                ...
                :
                <h2 className='text-blue-600 flex gap-2 items-center'><Mic/>
